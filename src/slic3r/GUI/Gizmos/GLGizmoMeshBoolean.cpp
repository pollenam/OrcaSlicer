...
void GLGizmoMeshBoolean::on_render()
{
    ...
    ColorRGB tool_color = {246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f};
...
void GLGizmoMeshBoolean::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    auto selectable = [this](const std::string& label, bool selected, const ImVec2& size_arg) {
        ...
        if (selected || hovered) {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, { 246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f, 1.0f });
        }
        else {
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 246.0f / 255.0f, 168.0f / 255.0f, 0.0f / 255.0f, 1.0f });
