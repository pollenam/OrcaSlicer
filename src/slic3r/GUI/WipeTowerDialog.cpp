...
wxString WipingDialog::BuildTextObjStr(bool multi_language)
{
    ...
    if (multi_language) {
        auto_flush_tip = _L("PollenAMOrcaSlicer would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in PollenAMOrcaSlicer > Preferences");
        ...
        auto_flush_tip = "PollenAMOrcaSlicer would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in PollenAMOrcaSlicer > Preferences";
