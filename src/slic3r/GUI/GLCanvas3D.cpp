...
void GLCanvas3D::LayersEditing::render_variable_layer_height_dialog(GLCanvas3D& canvas) {
    ...
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(0.9647f, 0.6588f, 0.0f, 0.00f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(0.9647f, 0.6588f, 0.0f, 0.00f));
